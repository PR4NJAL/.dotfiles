...
1) Read Documentation Specifics
2) Language syntax exploration
3) Explore Language Patterns And Techniques
4) Build a project

The project in question should be a Command Line Todo List Manager:
